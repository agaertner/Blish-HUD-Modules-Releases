...
namespace Nekres.Loading_Screen_Hints.Controls.Hints
{
    public class GuessCharacter : Control {
        ...
        public GuessCharacter(int rnd, Container parent) {
            ...
            CharacterTexture = LoadingScreenHintsModule.Instance.ContentsManager.GetTexture($@"characters/{cleanCharacterName}.png");
        ...
        protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds) {
            GlowFX.Parameters["Opacity"].SetValue(this.Parent?.Opacity ?? 0);
